...
To understand what this specific information may relate to, please refer to the page associated to the campaign type or the wider campaign category [in the doc](../mechanisms/types-of-campaign.md). These pages should explain in details what each parameter required from you is about.

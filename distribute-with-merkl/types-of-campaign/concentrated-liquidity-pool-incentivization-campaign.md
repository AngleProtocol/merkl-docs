...
- $w_{\text{fees}}$: Weight assigned to rewards based on fees earned.
- $w_{\text{A}}$: Weight assigned to rewards for Token0  in the pool.
- $w_{\text{B}}$: Weight assigned to rewards for Token1 in the pool.

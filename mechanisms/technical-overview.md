...
2. **User Participation**: Users interact with the protocol in various ways (e.g., providing liquidity, lending, borrowing, etc.) to become eligible for rewards/points as defined by the campaign rules.
